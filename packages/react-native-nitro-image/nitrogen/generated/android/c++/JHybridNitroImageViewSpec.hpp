...
namespace margelo::nitro::image {
  ...
  public:
    ...
    std::optional<std::shared_ptr<HybridImageSpec>> getPlaceholder() override;
    void setPlaceholder(const std::optional<std::shared_ptr<HybridImageSpec>>& placeholder) override;
