...
namespace margelo::nitro::image {
  ...
  public:
    // Methods
    std::shared_ptr<HybridImageSpec> createBlankImage(double width, double height, bool enableAlpha) override;
    std::shared_ptr<Promise<std::shared_ptr<HybridImageSpec>>> createBlankImageAsync(double width, double height, bool enableAlpha) override;
