...
open class HybridNitroImageViewSpec_cxx {
  ...
  public final var cachePriority: bridge.std__optional_double_ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_double_ in
        if let __unwrappedValue = self.__implementation.cachePriority {
    ...
    @inline(__always)
    set {
      self.__implementation.cachePriority = { () -> Double? in
