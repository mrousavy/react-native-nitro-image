...
namespace margelo::nitro::image {
  ...
  class HybridImageSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<HybridImageSpec> rotate(double degrees) = 0;
      virtual std::shared_ptr<Promise<std::shared_ptr<HybridImageSpec>>> rotateAsync(double degrees) = 0;
