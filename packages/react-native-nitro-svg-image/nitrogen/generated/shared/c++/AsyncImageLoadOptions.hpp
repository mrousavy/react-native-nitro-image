...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::svg::image::AsyncImageLoadOptions> final {
    static inline margelo::nitro::svg::image::AsyncImageLoadOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::svg::image::AsyncImageLoadOptions(
        JSIConverter<std::optional<margelo::nitro::svg::image::AsyncImagePriority>>::fromJSI(runtime, obj.getProperty(runtime, "priority")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::svg::image::AsyncImageLoadOptions& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, "priority", JSIConverter<std::optional<margelo::nitro::svg::image::AsyncImagePriority>>::toJSI(runtime, arg.priority));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<margelo::nitro::svg::image::AsyncImagePriority>>::canConvert(runtime, obj.getProperty(runtime, "priority"))) return false;
