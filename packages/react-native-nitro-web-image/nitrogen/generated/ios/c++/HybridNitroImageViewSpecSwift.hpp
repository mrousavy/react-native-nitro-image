...
namespace margelo::nitro::image {
  ...
  public:
    ...
    explicit HybridNitroImageViewSpecSwift(const NitroWebImage::HybridNitroImageViewSpec_cxx& swiftPart):
      HybridObject(HybridNitroImageViewSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroWebImage::HybridNitroImageViewSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroWebImage::HybridNitroImageViewSpec_cxx _swiftPart;
  };
