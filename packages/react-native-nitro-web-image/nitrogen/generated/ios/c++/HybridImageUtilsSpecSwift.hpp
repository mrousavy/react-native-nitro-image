...
namespace NitroWebImage { class HybridImageUtilsSpec_cxx; }
...
namespace margelo::nitro::image {
  ...
  public:
    ...
    explicit HybridImageUtilsSpecSwift(const NitroWebImage::HybridImageUtilsSpec_cxx& swiftPart):
      HybridObject(HybridImageUtilsSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroWebImage::HybridImageUtilsSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroWebImage::HybridImageUtilsSpec_cxx _swiftPart;
  };
