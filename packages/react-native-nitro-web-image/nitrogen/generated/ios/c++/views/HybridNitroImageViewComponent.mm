...
- (instancetype) init {
  if (self = [super init]) {
    std::shared_ptr<HybridNitroImageViewSpec> hybridView = NitroWebImage::NitroImageAutolinking::createNitroImageView();
...
- (void) updateView {
  // 1. Get Swift part
  NitroWebImage::HybridNitroImageViewSpec_cxx& swiftPart = _hybridView->getSwiftPart();
