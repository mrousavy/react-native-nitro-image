...
namespace NitroWebImage { class HybridImageFactorySpec_cxx; }
...
namespace margelo::nitro::image {
  ...
  public:
    ...
    explicit HybridImageFactorySpecSwift(const NitroWebImage::HybridImageFactorySpec_cxx& swiftPart):
      HybridObject(HybridImageFactorySpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroWebImage::HybridImageFactorySpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroWebImage::HybridImageFactorySpec_cxx _swiftPart;
  };
