...
public final class NitroWebImageAutolinking {
   ...
   */
  public static func createWebImageFactory() -> bridge.std__shared_ptr_margelo__nitro__web__image__HybridWebImageFactorySpec_ {
    let hybridObject = HybridWebImageFactory()
    return { () -> bridge.std__shared_ptr_margelo__nitro__web__image__HybridWebImageFactorySpec_ in
