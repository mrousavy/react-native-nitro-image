...
namespace margelo::nitro::image::bridge::swift {
  ...
  Func_void_std__shared_ptr_ArrayBuffer_ create_Func_void_std__shared_ptr_ArrayBuffer_(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = NitroWebImage::Func_void_std__shared_ptr_ArrayBuffer_::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void create_Func_void(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = NitroWebImage::Func_void::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_std__string create_Func_void_std__string(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = NitroWebImage::Func_void_std__string::fromUnsafe(swiftClosureWrapper);
  ...
  std::shared_ptr<margelo::nitro::image::HybridImageFactorySpec> create_std__shared_ptr_margelo__nitro__image__HybridImageFactorySpec_(void* _Nonnull swiftUnsafePointer) {
    NitroWebImage::HybridImageFactorySpec_cxx swiftPart = NitroWebImage::HybridImageFactorySpec_cxx::fromUnsafe(swiftUnsafePointer);
  ...
  #endif
    NitroWebImage::HybridImageFactorySpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
  ...
  std::shared_ptr<margelo::nitro::image::HybridImageUtilsSpec> create_std__shared_ptr_margelo__nitro__image__HybridImageUtilsSpec_(void* _Nonnull swiftUnsafePointer) {
    NitroWebImage::HybridImageUtilsSpec_cxx swiftPart = NitroWebImage::HybridImageUtilsSpec_cxx::fromUnsafe(swiftUnsafePointer);
  ...
  #endif
    NitroWebImage::HybridImageUtilsSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
