...
namespace margelo::nitro::web::image {
  ...
  std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::web::image::HybridImageSpec>>> JHybridWebImageFactorySpec::loadImageAsync(const std::string& url, const std::optional<AsyncImageLoadOptions>& options) {
