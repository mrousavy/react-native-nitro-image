...
internal struct ImageContainer: @unchecked Sendable {
#if os(macOS)
    /// A fetched image.
    ...
    internal init(image: PlatformImage, type: AssetType? = nil, isPreview: Bool = false, data: Data? = nil, userInfo: [UserInfoKey: Any] = [:]) {
    ...
    internal struct UserInfoKey: Hashable, ExpressibleByStringLiteral, Sendable {
        ...
        internal static let scanNumberKey: UserInfoKey = "com.github/kean/nuke/scan-number"
    }
