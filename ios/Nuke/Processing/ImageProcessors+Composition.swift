...
extension ImageProcessors {
    ...
    internal struct Composition: ImageProcessing, Hashable, CustomStringConvertible {
        let processors: [any ImageProcessing]

        /// Composes multiple processors.
        internal init(_ processors: [any ImageProcessing]) {
        ...
        internal static func == (lhs: Composition, rhs: Composition) -> Bool {
