...
extension ImageProcessors {
    ...
    internal struct RoundedCorners: ImageProcessing, Hashable, CustomStringConvertible {
        ...
        internal init(radius: CGFloat, unit: ImageProcessingOptions.Unit = .points, border: ImageProcessingOptions.Border? = nil) {
