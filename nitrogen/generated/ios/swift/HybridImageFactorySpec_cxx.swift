...
public class HybridImageFactorySpec_cxx {
  ...
  // Methods
  @inline(__always)
  public final func loadFromURLAsync(url: std.string, newApi: Bool) -> bridge.Result_std__shared_ptr_Promise_std__shared_ptr_margelo__nitro__image__HybridImageSpec____ {
    do {
      let __result = try self.__implementation.loadFromURLAsync(url: String(url), newApi: newApi)
