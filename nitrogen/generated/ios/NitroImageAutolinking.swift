...
public final class NitroImageAutolinking {
   ...
   */
  public static func createNitroImageView() -> bridge.std__shared_ptr_margelo__nitro__nitroimage__HybridNitroImageViewSpec_ {
    let hybridObject = HybridImageView()
    return { () -> bridge.std__shared_ptr_margelo__nitro__nitroimage__HybridNitroImageViewSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
