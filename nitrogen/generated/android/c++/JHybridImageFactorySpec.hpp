...
namespace margelo::nitro::image {
  ...
  public:
    ...
    std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::image::HybridImageSpec>>> loadFromAssetAsync(const std::string& assetId, const std::optional<AssetImageLoadOptions>& options) override;
